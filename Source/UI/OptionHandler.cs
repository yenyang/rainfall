        ...
        private static Dictionary<string, List<OptionsItemBase>> allOptions = new Dictionary<string, List<OptionsItemBase>>
        {
            ...
            },
            {
                "PUB", new List<OptionsItemBase>
                {
                     ...
                     new OptionsSlider()     {defaultValue = 0.6f,    uniqueName = "PoliceDepartments",         readableName = "Police Departments",          tooltipFormat = "F2",     max = 1f,    step = 0.05f},
            ...
            },
            {
                "PVT", new List<OptionsItemBase>
                {
                     ...
                     new OptionsSlider()     {defaultValue = 0.0f,    uniqueName = "TouristCommerical",           readableName = "Tourist Commercial Mod.",     tooltipFormat = "F2",     min = -0.3f,  max = 0.3f,    step = 0.05f},
