...
namespace Rainfall
{
    public class FreezeLandvalues : LevelUpExtensionBase
    {
        ...
        {
            if (Hydrology.instance._preRainfallLandvalues != null)
            {
                if (Hydrology.instance.isRaining == true && Hydrology.instance._preRainfallLandvalues[buildingID] > 0 && landValue > Hydrology.instance._preRainfallLandvalues[buildingID] && OptionHandler.getCheckboxSetting("FreezeLandvalues") == true || Hydrology.instance.holdLandValue == true && OptionHandler.getCheckboxSetting("FreezeLandvalues") == true && landValue > Hydrology.instance._preRainfallLandvalues[buildingID])
                {
